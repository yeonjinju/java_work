...
public class MyFrame extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent e) {
	   ...
	   /*
	    * java에서 문자열의 참조값이 같은지 비교할떄는 비교 연산자 == 를 이용해서 비교하면 되지만 문자열의 참조값이 아닌 내용이 같은지 비교할때는
	    * String의 .equals()메소드를 이용해서 비교해야 한다.
	    * 
	    * 왜냐하면 java에서는 문자열을 만드는 방법에 따라서 내용은 같지만 참조값이 다르게 나오는 경우도 있기 때문이다. 
	    * 따라서 문자열의 내용이 같은지 정확히 비교할때는 반드시 .equals() 메소드를 이용해야 한다. (이걸 까먹으면 밤 셀수도 있음)
	    * 
	    */
	   if(cmd.equals("send")) {
